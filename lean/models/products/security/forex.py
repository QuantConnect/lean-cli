...
class ForexProduct(SecurityProduct):
    """The ForexProduct class supports downloading forex data with the `lean data download` command."""
    ...
    def build(cls, organization: QCFullOrganization) -> List[Product]:
        ...
        return [ForexProduct(data_type, market, ticker, resolution, start_date, end_date)]
