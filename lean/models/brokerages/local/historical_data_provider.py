...
class HistoricalDataProvider(LeanConfigConfigurer):
    """The JsonModule implementation for the Json historical data provider module."""

    def __init__(self, json_module_data: Dict[str, Any]) -> None:
        super().__init__(json_module_data)
