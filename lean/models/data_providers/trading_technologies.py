...
from lean.models.brokerages.local import TradingTechnologiesBrokerage
from lean.models.config import LeanConfigConfigurer


class TradingTechnologiesDataProvider(LeanConfigConfigurer):
    ...
    def build(cls, lean_config: Dict[str, Any], logger: Logger) -> LeanConfigConfigurer:
        return TradingTechnologiesDataProvider(TradingTechnologiesBrokerage.build(lean_config, logger))
    ...
    def configure(self, lean_config: Dict[str, Any], environment_name: str) -> None:
        ...
        lean_config["data-downloader"] = "TradingTechnologiesDataDownloader"
