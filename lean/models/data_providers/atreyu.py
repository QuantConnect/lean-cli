...
from lean.models.brokerages.local import AtreyuBrokerage
from lean.models.config import LeanConfigConfigurer


class AtreyuDataProvider(LeanConfigConfigurer):
    ...
    def build(cls, lean_config: Dict[str, Any], logger: Logger) -> LeanConfigConfigurer:
        return AtreyuDataProvider(AtreyuBrokerage.build(lean_config, logger))
    ...
    def configure(self, lean_config: Dict[str, Any], environment_name: str) -> None:
        ...
        lean_config["data-downloader"] = "AtreyuDataDownloader"
