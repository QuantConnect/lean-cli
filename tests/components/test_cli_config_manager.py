...
def test_get_option_by_key_should_return_option_with_matching_key() -> None:
...
def test_get_option_by_key_should_raise_error_when_no_option_with_matching_key_exists() -> None:
    manager = CLIConfigManager(mock.Mock(), mock.Mock())
